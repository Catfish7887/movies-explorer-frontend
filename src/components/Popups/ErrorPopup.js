function ErrorPopup(props) {
  return (
    <div
      ...
      className={props.isOpened ? 'popup popup_opened popup_type_error' : 'popup'}
    >
      <div className="popup__container popup__container_type_error">
        ...
        <span className='popup__name'>Что-то пошло не так. Проверьте Ваше интернет-соединение или повторите попытку позже</span>
...
{/* <div className="popup__container popup__container_type_tooltip">
        ...
        <span className='popup__name'>Что-то пошло не так. Проверьте Ваше интернет-соединение или повторите попытку позже</span>
        <button type="button" aria-label="Закрыть" onClick={onClose} className="popup__close-btn"></button>
      </div> */}
