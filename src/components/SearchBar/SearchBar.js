  ...
  return (
    <div className="searchbar">
      ...
      <form className="searchform">
        <input type='text' name="film-input" className="searchform__input" />
        <button type="submit" className="searchform__submit-button"></button>
        <input type='checkbox' name="film-checkbox" />
        <label className="searchform__label" for="film-checkbox"></label>
      </form>
    </div>
  );
};
